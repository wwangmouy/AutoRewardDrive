...
if __name__ == '__main__':
    ...
    selected_models = [f"model_{i}_steps.zip" for i in [300000]]
    tensorboard_path = './tensorboard'
    
    # change the target model dir as you want
    target_model_dir = '/home/ubuntu/wy/AutoRewardDrive-V2/AutoRewardDrive/tensorboard/AutoRewardedSAC_20260127_114754_id3'

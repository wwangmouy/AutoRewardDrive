...
if __name__ == '__main__':
    ...
    selected_models = [f"model_{i}_steps.zip" for i in [70000]]
    tensorboard_path = './tensorboard'
    
    # change the target model dir as you want
    target_model_dir = '/home/ubuntu/wy/code/AutoRewardDrive/tensorboard/AutoRewardedSAC_20260310_205829_id3'
